...
public class dataJabatan extends javax.swing.JFrame {
    ...
    private void autonumber(){
         String sql = "SELECT * FROM jabatan ORDER BY id_jabatan DESC";
        try{          
            Statement s = conn.createStatement();
            ResultSet r = s.executeQuery(sql);
            
            if (r.next()) {
               String NoBarang = r.getString("id_jabatan").substring(0);
    ...
    private void ShowData(){
         Object[] Baris = {"ID Jabatan","Nama Jabatan","Keterangan"};
            tabmode = new DefaultTableModel(null, Baris);
            String cariitem=txcari.getText();
            
            try {
                String sql = "SELECT * from jabatan where id_jabatan like '%"+cariitem+"%' or nama_jabatan like '%"+cariitem+"%' order by id_jabatan asc";
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        String sql = "update jabatan set nama_jabatan=?,keterangan_jabatan=? where id_jabatan = '"+txid.getText()+"'";
        try {
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        if (ok == 0){
            String sql = "delete from jabatan where id_jabatan='"+txid.getText()+"'";
